...
export function PlayerStats({ score, moves, totalCells, startsAt }: PlayerStatsProps) {
  ...
  return (
    <div className="panel p-3">
      <h3 className="label-eyebrow mb-3">Stats</h3>
      ...
      <div className="flex items-center justify-center mb-3">
        <div className="relative w-20 h-20">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <span className="font-display text-lg font-extrabold text-text tabular-nums">{score}</span>
            <span className="text-[9px] text-text-3 uppercase tracking-wider">cleared</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-1.5">
        <div className="stat-tile">
          <div className="font-display text-sm font-bold text-text tabular-nums">{moves}</div>
          <div className="text-[9px] text-text-3 uppercase tracking-wider">Moves</div>
        </div>
        <div className="stat-tile">
          <div className="font-display text-sm font-bold text-text tabular-nums">{clearPct}%</div>
          <div className="text-[9px] text-text-3 uppercase tracking-wider">Board</div>
        </div>
        <div className="stat-tile">
          <div className="font-display text-sm font-bold text-accent tabular-nums">{efficiency}</div>
          <div className="text-[9px] text-text-3 uppercase tracking-wider">/sec</div>
        </div>
        <div className="stat-tile">
          <div className="font-display text-sm font-bold text-gold tabular-nums">{peakDisplay}</div>
          <div className="text-[9px] text-text-3 uppercase tracking-wider">Peak</div>
        </div>
      </div>
    </div>
  );
